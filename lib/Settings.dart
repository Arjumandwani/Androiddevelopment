...
class _SettingsState extends State<Settings> {
  ...
  var isttitle=["THEME","SPECIAL NIGHTTIME THEME","TIMED RANGE","NIGHTTIME THEME","DEFAULT STARTING PAGE","COMPACT STORIES","SHOW STORY THUMBNAILS",
    "SHOW STORY POINTS","SHOW STORY INDICES","COMPACT HEADER","LEFT ALIGN COMMENTS BUTTON",
    "ENABLE FOLDABLE SUPPORT","TRANSPARENT STATUS BAR" ,"FAVICON PROVIDER",
 "HIGHLIGHT HOT STORIES","TITLE AND COMMENT FONT","INTEGRATED WEBVIEW","PREOLD WEBSITES","MATCH WEB VIEW DARKMODE TO THEME","BLOCK WEBVIEWS ADS","REDIRECT TWITTER/X TO NITTER",
    "COMMENTS TEXT SIZE","COMMENT SORTING","HIDE TEXT OF COLLAPSED COMMENT","AUTO-COLLAPSE TOP LEVEL COMMENTS",
    "SHOW NAVIGATION BUTTONS","MONOCHROME THREAD INDICATORS","SHOW TOP LEVEL THREAD INDICATORS","ALWAYS OPEN COMMENTS","DISABLE SWIPE BACK FROM COMMENTS",
    "ANIMATE COMMENTS","SCROLLBAR","ARXIV","GITHUB","TWITTER","WIKIPEDIA","USE EXTERNAL BROWSER",
    "FILTER STORIES","HIDE JOB POSTS","HIDE CLICKED POSTS","EXPORT BOOKMARKS","IMPORT BOOKMARKS",
        "CLEAR CLICKED STORIES","GITHUB","ABOUT"
    ];


  var istleading=[Icons.fiber_manual_record_rounded,(Icons.nightlight),Icons.access_time_outlined,Icons.mode_night_rounded,
  Icons.web_outlined,Icons.view_compact,Icons.star,Icons.thumbs_up_down_rounded,
  Icons.format_list_numbered,Icons.density_small_sharp,Icons.front_hand_sharp,
  Icons.rectangle_outlined,Icons.remove_red_eye_outlined,Icons.sports_basketball_rounded,
  Icons.local_fire_department,Icons.text_format,Icons.web,
  Icons.downloading,Icons.water_drop_rounded,Icons.block,Icons.arrow_back_outlined,
  Icons.text_fields,Icons.sort_outlined,Icons.message_rounded,Icons.minimize_rounded,Icons.navigation_sharp,
  Icons.color_lens,Icons.drag_indicator,Icons.double_arrow_sharp,Icons.thumb_up_off_alt,
  Icons.animation,Icons.bar_chart,Icons.handyman,Icons.catching_pokemon_outlined,
  Icons.credit_card_off,Icons.book,
  Icons.open_in_browser,Icons.line_weight,Icons.hide_image_rounded,Icons.block_flipped,
  Icons.bookmark_outline_rounded,Icons.bookmark,Icons.clear,Icons.receipt_rounded,Icons.info_sharp];

  var istsubtitle=["MATERIAL YOU(auto)","","9.00-6.00","DARK THEME", "TOP STORIES","HIDE POINTS ,DOMAIN AND TIME",
  "","","","SMALLER MARGINS FOR 'TOP STORIES' HEADER","LEFT ALIGN BUTTON","ENABLE FOLDABLE SUPPORT",
  "TRANSPARENT STATUS BAR","FAVICON PROVIDER","NEVER","PRODUCT SANS(DEFAULT)","OPENS WEBSITES IN THE APP WHICH HAS A HIT ON PERFORMANCE",
  "NEVER","","MAY CAUSE SOME SITES TO STOP WORKING AND HAS A PERFORMANCE PENALTY",""," STANDARD(15P)",
  "DEFAULT","","","NAVIGATE BETWEEN TOP LEVEL COMMENTS","GRAY LINES NEXT TO CHILD COMMENTS",
  "MAKES IT EASIER TO SEPARATE TOP LEVEL COMMENTS","CLICKING A STORY TAKES YOU DIRECTLY TO THE COMMENTS VIEW",
  "","","","","","REQUIRES NITTER REDIRECT TO BE ACTIVE",""," IN PLACE OF CUSTOM TABS","HIDE STORIES BASED ON WORDS IN TITLE",
  "INCLUDES WHO IS HIRING POSTS","APPLIES ON REFRESH","EXPORTS BOOKMARKS","IMPORT BOOKMARKS","","",""];
  ...
  Widget build(BuildContext context) {
    List<bool> isttrailing=[false,true,false,false,false,true,true,true,true,true,true,true,true,false,false,false,true,false,
    true,true,true,false,false,true,true,true,true,true,true,true,true,true,true,true,true,true,true,false,true,true,false,false,false,false,false];
    return Scaffold(
        ...
        child: Column(
            children:[ ListView.builder(
              ...
              return ListTile(
                                      ...
                                      child: AlertDialog(
                                        ...
                                        content: Column(
                                          children: [
                                            ...
                                            RadioListTile(value: 6,
                                                groupValue: 1,
                                                onChanged: (val) {

                                                }),
                                            RadioListTile(value: 7,
                                                groupValue: 1,
                                                onChanged: (val) {

                                                }),
                                            RadioListTile(value: 8,
                                                groupValue: 1,
                                                onChanged: (val) {
                ...
                trailing: Visibility(visible: isttrailing[index],
                    child: Switch(value: _isswitch, onChanged: (value) {
                      _isswitch = value;
